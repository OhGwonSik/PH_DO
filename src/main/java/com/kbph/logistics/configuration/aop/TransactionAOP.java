package com.kbph.logistics.configuration.aop;
...
import com.kbph.logistics.configuration.db.DataSourceConfig;
...
public class TransactionAOP {
	...
	private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.kbph.logistics..*Service.*(..))";
